...
public class SearchSubmit_FullName_InvalidDateRange_OneRoom_OneGuest_ClicksFromComponentToComponent_InvalidSearch {
    public static void main(String[] args) throws InterruptedException {
        ...
        WebElement errorSearch = wait.until(ExpectedConditions.visibilityOfElementLocated(By.className("date_error")));

        assertEquals("Please select an appropriate date range", errorSearch.getText());
