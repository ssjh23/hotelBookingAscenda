...
public class PythonScriptTest {
    public ArrayList<String> searchBarFuzzed() throws IOException {
        ProcessBuilder processSearchBar = new ProcessBuilder("python", resolvePythonScriptPath("C:\\Users\\zach_\\Documents\\Ascenda\\SeleniumTest\\src\\main\\java\\org\\FuzzedTest\\SearchBar\\FuzzerGeneratorSearchbar.py"));
    ...
    public ArrayList<String> datesStartFuzzed() throws IOException {
        ProcessBuilder processDatesStart = new ProcessBuilder("python", resolvePythonScriptPath("C:\\Users\\zach_\\Documents\\Ascenda\\SeleniumTest\\src\\main\\java\\org\\FuzzedTest\\SearchBar\\FuzzerGeneratorDatesStarting.py"));
    ...
    public ArrayList<String> datesEndFuzzed() throws IOException {
        ProcessBuilder processDatesEnd = new ProcessBuilder("python", resolvePythonScriptPath("C:\\Users\\zach_\\Documents\\Ascenda\\SeleniumTest\\src\\main\\java\\org\\FuzzedTest\\SearchBar\\FuzzerGeneratorDatesEnd.py"));
